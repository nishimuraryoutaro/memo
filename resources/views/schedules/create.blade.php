                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('schedules.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="start_date" type=end_date" class="form-control @error('start_date') is-invalid @enderror" name="start_date" value="{{ old('start_date') }}" required autocomplete="name" autofocus>
